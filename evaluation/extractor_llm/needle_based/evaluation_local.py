...
from utils.prompt_template import  format_extractNeedleTag_from_query_tagContent_zero_shots_prompt
...
for context_length in context_lengths:
    ...
    for depth_percent in document_depth_percents:
        ...
        for seg in segments:
            ...
            idx += 1
        prompt = format_extractNeedleTag_from_query_tagContent_zero_shots_prompt(query=retrieval_question, content=tag_content)
        context = tag_content
        ...
        needles_name = "local_needle_test"
